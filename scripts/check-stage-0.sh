...
#     and .opencode/plugins/leyline.js
...
if [[ "$pkg_ver" != "$ext_ver" || "$pkg_ver" != "$shim_ver" ]]; then
    echo "VERSION DRIFT: package.json=$pkg_ver gemini-extension.json=$ext_ver .opencode/plugins/leyline.js=$shim_ver" >&2
    fail=1
fi
